...
function updateSum() {
  ...
  document.getElementById(
    "subTotal"
  ).innerHTML = `Zwischensumme: ${subTotal.toFixed(2)}€`;
  document.getElementById(
    "deliveryCosts"
  ).innerHTML = `Lieferkosten: ${deliveryCost.toFixed(2)}€`;
  document.getElementById("totalCosts").innerHTML = `Gesamt: ${totalSum.toFixed(
    2
  )}€`;
}
